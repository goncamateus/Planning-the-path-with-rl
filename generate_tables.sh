...
sbatch -w cluster-node4 -o test_8.log run_test.sh c1 Obstacle-v0
sbatch -w cluster-node4 -o test_9.log run_test.sh c1 Obstacle-v0 --caps
sbatch -w cluster-node5 -o test_10.log run_test.sh c1 Obstacle-v1
sbatch -w cluster-node5 -o test_11.log run_test.sh c1 Obstacle-v1 --caps
